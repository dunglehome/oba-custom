...
public class StopAction extends AbstractWhereAction implements ModelDriven<WebappArrivalsAndDeparturesModel>
{
	...
	@Override
	@Actions({ @Action(value = "/where/standard/stop"), @Action(value = "/where/iphone/stop"), @Action(value = "/where/text/stop"), @Action(value = "/where/sign/stop"), @Action(value = "/where/custom/stop") })
	public String execute() throws ServiceException
	{
		...
		logUserInteraction("stopIds", _model.getStopIds(), "routeIds", _model.getRouteFilter());
