...
public class WebappArrivalsAndDeparturesModel extends ArrivalsAndDeparturesModel
{
	...
	public SituationsPresentation getSituationsForArrivalAndDeparture(ArrivalAndDepartureBean arrivalAndDeparture)
	{
	...
	public void setShowArrivalsCustom(boolean showArrivalsCustom)
	{
		...
		super.setShowArrivalsCustom(showArrivalsCustom);
		_arrivalsAndDeparturesPresentation.setShowArrivalsCustom(showArrivalsCustom);
	}
	
	public boolean isShowArrivalsCustom()
	{
		// TODO Auto-generated method stub
		return _arrivalsAndDeparturesPresentation.isShowArrivalsCustom();
	}
